 ...
 * @version 1.0
 */
public class WhileListening extends Action implements SourceAction, EventListenerModel {
    public static final String ID = WhileListening.class.getCanonicalName();
